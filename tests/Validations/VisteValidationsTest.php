...
namespace App\Test\Validations;
...
/**
 * Description of VisteValidationsTest
 *
 * @author Antho
 */
class VisteValidationsTest extends KernelTestCase{
    ...
    public function testNonValidTempmaxVisite(){
        $visite = $this->getVisite()
                ->setTempmin(20)
                ->setTempmax(18);
        $this->assertErrors($visite,1, "min=20, max=18 devrais échouer");
    }
